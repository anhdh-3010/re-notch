...
struct SettingsView: View {
            ...
            SettingCard(title: "Display & Timing", icon: "display", iconColor: .purple) {
                VStack(spacing: 0) {
                    ...
                    AppleValueSlider(
                        ...
                        subtitle: "Time before the notch shrinks back after unpinning",
    ...
    private var appearanceTabContent: some View {
        VStack(spacing: 16) {
            ...
            SettingCard(title: "Compact Notch", icon: "rectangle.compress.vertical", iconColor: .cyan) {
                VStack(spacing: 0) {
                    SettingRow(
                        title: "Automatic sizing",
                        subtitle: "Width and height follow the MacBook camera notch, plus one icon wing on each side. External displays use a virtual notch."
                    ) {
