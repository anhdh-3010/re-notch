...
final class ScreenManager: ObservableObject {
    ...
    /// Reads the hardware notch size for a screen. Nil on displays
    /// without a camera housing (external monitors, older Macs).
    static func physicalNotchMetrics(for screen: NSScreen) -> PhysicalNotchMetrics? {
